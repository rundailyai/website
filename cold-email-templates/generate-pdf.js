...
`;
  ...
  const outputPath = path.join(baseDir, 'COLD-EMAIL-TEMPLATE-LIBRARY.pdf');
    ...
    const pdf = await mdToPdf(
      { content: markdown },
      {
        ...
        pdf_options: {
          ...
          footerTemplate: `
            <div style="font-size: 9px; color: #64748b; text-align: center; width: 100%; margin: 0 0.75in;">
              <span style="float: left;">Cold Email Template Library</span>
              <span style="float: right;">Page <span class="pageNumber"></span> of <span class="totalPages"></span></span>
            </div>
          `
        },
        stylesheet: [path.join(baseDir, 'pdf-styles.css')],
